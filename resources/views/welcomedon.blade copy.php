...
<!--         Background image with overlay  
        <div class="absolute inset-0 bg-cover bg-center bg-no-repeat" style="background-image: url('{{ asset('images/bgSide.png') }}')"></div>
        <div class="absolute inset-0 bg-black/55 dark:bg-black/65"></div>
 -->
        <!-- tracking-[0.2em] -->
             <!--  Services Section -->
            <section id="services" class="mt-max dark:bg-gray-900/90 bg-gradient-to-br from-[#4f6ba3] to-[#5a7bbf]  text-white py-20 overflow-hidden relative">
                  ...
                  <div class="max-w-7xl mx-auto px-6 relative z-10">
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                              ...
                              <div class="custom-video-order flex justify-center items-center relative p-0 py-0 sm:py-6 xl:py-10 lg:py-10 md:py-16 animate-fade-in-left order-2 lg:order-2">
                                  <div class="relative w-full max-w-[260px] sm:max-w-[300px] md:max-w-[340px] lg:max-w-[380px] xl:max-w-[420px] aspect-[9/16] rounded-2xl sm:rounded-3xl shadow-2xl overflow-hidden transform hover:scale-[1.02] transition-transform duration-500 ring-2 ring-white/20">
                                      ...
                                      <div class="absolute bottom-2 sm:bottom-3 left-1/2 -translate-x-1/2 flex flex-row items-center gap-2 sm:gap-3 bg-black/70 text-white rounded-xl sm:rounded-2xl px-3 sm:px-4 py-2 sm:py-2.5 shadow-xl backdrop-blur-md"
                                          style="width:calc(100% - 2rem); max-width:360px;">
                                          
                                          <!-- Play / Pause Button -->
                                          <button id="videoPlayPause" 
                                                  type="button" 
                                                  aria-label="{{ __('site.aria.play_pause') }}"
                                                  class="w-9 h-9 sm:w-10 sm:h-10 md:w-11 md:h-11 rounded-full bg-white/20 hover:bg-white/30 flex items-center justify-center transition-colors duration-200 shrink-0">
                                              <svg id="iconPlay" class="w-5 h-5 sm:w-6 sm:h-6" viewBox="0 0 24 24" fill="currentColor">
                                                  <path d="M8 5v14l11-7L8 5z"/>
                                              </svg>
                                              <svg id="iconPause" class="w-5 h-5 sm:w-6 sm:h-6 hidden" viewBox="0 0 24 24" fill="currentColor">
                                          ...
                                          <button id="videoMute" 
                                                  ...
                                                  class="w-9 h-9 sm:w-10 sm:h-10 md:w-11 md:h-11 rounded-full bg-white/20 hover:bg-white/30 flex items-center justify-center transition-colors duration-200 shrink-0">
                                              <svg id="iconVolume" class="w-5 h-5 sm:w-6 sm:h-6" viewBox="0 0 24 24" fill="currentColor">
                                                  <path d="M5 9v6h4l5 4V5L9 9H5z"/>
                                                  <path d="M16.5 8.5a5 5 0 010 7" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
                                              </svg>
                                              <svg id="iconMuted" class="w-5 h-5 sm:w-6 sm:h-6 hidden" viewBox="0 0 24 24" fill="currentColor">
                                                  <path d="M5 9v6h4l5 4V5L9 9H5z"/>
                                          ...
                                          <!-- Volume Slider -->
                                          <div class="flex items-center justify-center flex-1 ml-1 sm:ml-2 min-w-0">
                                              <input id="videoVolume" 
                                                    ...
                                                    step="5" 
                                                    value="0"
                                                    class="w-full h-2 accent-white cursor-pointer"
                              ...
                              <div class="leading-relaxed text-base md:text-lg animate-fade-in-left order-1 lg:order-1">
                                <!-- Titre -->
                                <div class="mb-8">
                                ...
                                <div class="mt-8">
                                  <a
                                    href="/noservices"
                                    class="inline-flex items-center gap-2 bg-white text-[#1b2336]
                                          font-semibold px-5 py-2.5 rounded-full shadow
                  ...
                  <script>
                    document.addEventListener('DOMContentLoaded', () => {
                      ...
                      const initialVol = vol ? parseInt(vol.value, 10) / 100 : 0;
                      video.volume = Number.isFinite(initialVol) ? initialVol : 0;
                      ...
                      if (tryPlay && typeof tryPlay.then === 'function') {
                        tryPlay.then(() => updPlay(true)).catch(() => updPlay(false));
                      } else {
  ...
  <body class="bg-white text-gray-900 dark:text-gray-100 font-sans dark:bg-gray-900 flex flex-col min-h-screen">
    ...
    <main class="flex-grow">
        <!-- Section Hero -->
            ...
            <!-- Section About flottante améliorée -->  <!-- delete bg-white/90 md:backdrop-blur-md -->
      ...
      <section id="services" class="mt-max dark:bg-gray-900/90 bg-gradient-to-br from-[#4f6ba3] to-[#5a7bbf] text-white py-20 overflow-hidden relative">
        ...
        <div class="hidden md:block absolute -bottom-24 -right-24 w-96 h-96 bg-white/10 rounded-full blur-3xl opacity-20"></div>
          ...
          <div class="absolute bottom-1 left-1/2 -translate-x-1/2 flex flex-row items-center gap-3 bg-black/60 text-white rounded-2xl px-4 py-2 shadow-xl backdrop-blur-md"
              style="width:calc(100% - 2rem); max-width:340px;">
            <!-- Play / Pause -->
            <button id="videoPlayPause" type="button" aria-label="Lire / Pause"
              ...
              <svg id="iconPlay" class="w-6 h-6" viewBox="0 0 24 24" fill="currentColor"><path d="M8 5v14l11-7L8 5z"/></svg>
              <svg id="iconPause" class="w-6 h-6 hidden" viewBox="0 0 24 24" fill="currentColor"><path d="M6 5h4v14H6zM14 5h4v14h-4z"/></svg>
            </button>

            <!-- Mute / Unmute -->
            <button id="videoMute" type="button" aria-label="Activer / Couper le son"
                    class="w-10 h-10 rounded-full bg-white/20 hover:bg-white/30 flex items-center justify-center transition">
              <svg id="iconVolume" class="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
                <path d="M5 9v6h4l5 4V5L9 9H5z"/>
                <path d="M16.5 8.5a5 5 0 010 7" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
              </svg>
              <svg id="iconMuted" class="w-6 h-6 hidden" viewBox="0 0 24 24" fill="currentColor">
                <path d="M5 9v6h4l5 4V5L9 9H5z"/>
                <path d="M19 9l-6 6M13 9l6 6" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
              </svg>
            </button>
            ...
            <div class="flex items-center justify-center ml-2">
              <input id="videoVolume" type="range" min="0" max="100" step="5" value="0"
                    class="w-24 h-2 accent-white cursor-pointer"
                    aria-label="Volume" />
            </div>
          </div>
            ...
            <div class="leading-relaxed text-base md:text-lg animate-fade-in-left order-1">
              <div class="mb-8">
                <h2 class="text-4xl md:text-5xl sm:text-5xl font-extrabold pb-2">{{ __('site.services.title') }}</h2>
                <div class="h-1.5 w-24 bg-white rounded-full"></div>
              </div>
              <p class="mb-6 text-white/90">{!! __('site.services.desc') !!}</p>
              ...
              document.addEventListener('DOMContentLoaded', () => {
                ...
                // initialize volume from range input (if present)
                const initialVol = vol ? parseInt(vol.value, 10) / 100 : 0;
                video.volume = Number.isFinite(initialVol) ? initialVol : 0;
                video.muted = video.volume === 0;
                  ...
                  playBtn.addEventListener('click', () => {
                    if (video.paused) {
                      ...
                      if (playPromise !== undefined) {
                        playPromise.then(() => updPlay(true)).catch(() => updPlay(false));
                      } else {
                        updPlay(true);
                      }
                    } else {
                ...
                // Try autoplay (handle browser blocking)
                const tryPlay = video.play();
                if (tryPlay && typeof tryPlay.then === 'function') {
                  tryPlay.then(() => {
                    updPlay(true);
                  }).catch(() => {
                    // autoplay blocked — show paused UI (user can press play)
                    updPlay(false);
                  });
                } else {
        ...
        <section id="pourquoi" class="relative py-16 md:py-24 bg-white dark:bg-gray-900 overflow-hidden isolate">
          ...
          <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
            ...
            <div class="text-center mb-12 md:mb-20">
               <h1 class="text-4xl md:text-5xl  sm:text-5xl  font-extrabold tracking-tight text-gray-900 dark:text-white leading-tight whitespace-normal sm:whitespace-nowrap">
                  {!! __('site.why.title') !!}
                </h1>              
            ...
            <!-- Card 1 -->
              <div class="group flex flex-col items-center text-center p-8 border border-gray-200 dark:border-gray-800 rounded-2xl bg-white dark:bg-gray-800 shadow-lg hover:shadow-2xl dark:hover:shadow-blue-500/20 transition-all duration-300 ease-in-out transform hover:-translate-y-2 relative overflow-hidden">
                ...
                <div class="w-16 h-16 rounded-full bg-gradient-to-br from-[#4f6ba3] to-blue-400 flex items-center justify-center text-white shadow-xl mb-6 relative z-10">
        ...
        <style>
          ...
          .animation-delay-4000 {
            ...
            <section id="blog" class="py-20 bg-gradient-to-br from-[#4f6ba3] to-[#5a7bbf] text-white py-20 overflow-hidden relative">
              ...
              <div class="max-w-7xl mx-auto px-6">
                ...
                <div class="text-center mb-16">
                  <h2 class="text-4xl md:text-5xl sm:text-5xl font-extrabold text-white relative inline-block pb-4">
                    {{ __('site.blog.title') }}
                    <span class="absolute left-1/2 bottom-0 transform -translate-x-1/2 w-28 h-1.5 bg-[#e5ecf4] rounded-full"></span>
                  </h2>
                  ...
                  @forelse($posts as $post)
                    ...
                    <article class="bg-white rounded-2xl shadow-lg overflow-hidden transform transition-all duration-500 hover:scale-[1.03] hover:shadow-2xl group relative border border-gray-100">
                      <a href="{{ route('pages.blog.show', $post) }}" class="block focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#4f6ba3]">
                        ...
                        <div class="p-6">
                          <h3 class="text-2xl font-bold text-gray-900 mb-2 leading-tight group-hover:text-[#5a7bbf] transition-colors duration-300 line-clamp-2">
                            {{ $post->title }}
                          </h3>
          ...
          <section id="faq" class="bg-white dark:bg-gray-900 py-20">
            <div class="max-w-6xl mx-auto px-4">
              <h2 class="text-4xl md:text-5xl sm:text-5xl font-bold text-gray-900 dark:text-white text-center mb-6">{{ __('site.faq.title') }}</h2>
              <p class="text-center text-lg text-gray-600 dark:text-gray-300 mb-12 mx-auto">{{ __('site.faq.subtitle') }}</p>
              <div class="space-y-6">
                            
                <details class="group border-b-2 border-[#4f6ba3]/20 dark:border-[#5a7bbf]/30 pb-4 hover:border-[#4f6ba3]/40 dark:hover:border-[#5a7bbf]/50 transition-colors">
            ...
            <section id="contact" class="bg-white text-gray-800 py-16 dark:bg-gray-900 dark:text-gray-100">
                <div class="max-w-5xl mx-auto px-4">
                    <div class="text-center mb-12">
                      <h2 class="text-4xl md:text-5xl sm:text-5xl font-bold mb-4 dark:text-white">{{ __('site.contact.title') }}</h2>
                      <p class="text-lg dark:text-gray-300">
                        ...
                        <p class="text-base text-gray-600 mb-6 dark:text-gray-300">{!! __('site.contact.desc') !!}</p>
                          ...
                          <div class="flex items-start mb-6 space-x-4">
                            <span class="flex h-10 w-10 items-center justify-center rounded-full bg-[#4f6ba3]/10 text-[#4f6ba3]">
                              <svg class="h-6 w-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M12 21s-6.5-5.086-6.5-10.5A6.5 6.5 0 0 1 18.5 10.5C18.5 15.914 12 21 12 21Z"/><circle cx="12" cy="10.5" r="2.5"/></svg>
                            </span>
                            <div>
                          ...
                          <div class="flex items-start mb-6 space-x-4">
                            <span class="flex h-10 w-10 items-center justify-center rounded-full bg-[#4f6ba3]/10 text-[#4f6ba3]">
                              <svg class="h-6 w-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16v16H4z"/><path d="M22 6.92V17a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V6.92a2 2 0 0 1 .76-1.56L12 12l9.24-6.64A2 2 0 0 1 22 6.92Z"/></svg>
                            ...
                            <div>
                              ...
                              <p class="dark:text-gray-300">{{ $siteSettings?->email ?? 'contact@offitrade.fr' }}</p>
                                      ...
                                      <!-- Google Map (Free Method) -->
                  <div class="mt-8 w-full h-80 rounded-lg shadow-lg overflow-hidden">
                        @php
                ...
                <button type="submit"
                          class="w-full bg-[#4f6ba3] text-white py-2 rounded-md hover:bg-[#a1b6d8] transition flex items-center justify-center gap-2" id="contact-submit-btn">
                  <svg data-button-spinner class="hidden h-5 w-5 animate-spin text-white" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
